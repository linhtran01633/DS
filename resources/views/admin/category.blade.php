                ...
                <form  action="{{route('admin.category.add')}}" method="POST" >
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div>
                            ...
                            <select id="Danh Mục" required = "" name="category_parent_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        ...
                        <div class="p-4 md:p-5 space-y-4">
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                <div class="sm:col-span-2">
                                    ...
                                    <select id="category_parent_id_popup" required = "" name="category_parent_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                        <option value="">Chọn Danh mục thuốc</option>
                                        @foreach ($categoryParents as $categoryParent)
                                            <option value="{{$categoryParent->id}}">{{$categoryParent->name}}</option>
                                        @endforeach
